...
namespace Soda
{
    ...
    static bool argumentMatches(OptionKind kind, const std::string &optName)
    {
        ...
        case OK_HELP:
#ifdef SODA_WIN32
            if (optName == "/h" || optName == "/H" || optName == "/?"
                || optName == "/help" || optName == "/HELP")
                result = true;
#else
        ...
        case OK_OUTPUT:
#ifdef SODA_WIN32
            if (optName == "/o" || optName == "/O" || optName == "/output"
                || optName == "/OUTPUT")
                result = true;
#else
    ...
    {
        std::cout << "Usage: soda [options] input_files...\n"
                     "\n"
                     ...
                     "\n"
                     "Written and maintained by Matthew Brush "
