...
namespace Soda
{
	...
	void AstDefaultVisitor::visit(AstIfExpr &n) { n.acceptChildren(*this); }
	void AstDefaultVisitor::visit(AstCallExpr &n) { n.acceptChildren(*this); }
	void AstDefaultVisitor::visit(AstIndexExpr &n) { n.acceptChildren(*this); }
	void AstDefaultVisitor::visit(AstMemberExpr &n) { n.acceptChildren(*this); }
	...
	void AstDefaultVisitor::visit(AstReturnStmt &n) { n.acceptChildren(*this); }
	void AstDefaultVisitor::visit(AstBreakStmt &n) { n.acceptChildren(*this); }
	void AstDefaultVisitor::visit(AstContinueStmt &n) { n.acceptChildren(*this); }
	void AstDefaultVisitor::visit(AstGotoStmt &n) { n.acceptChildren(*this); }
	void AstDefaultVisitor::visit(AstIfStmt &n) { n.acceptChildren(*this); }
	void AstDefaultVisitor::visit(AstWhileStmt &n) { n.acceptChildren(*this); }
